...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        int movePower = (int) (Math.random() * 20 + 5);
        ...
        int rivalHealth = (int) (Math.random() * 80 + 150);
        int rivalPower = (int) (Math.random() * 15 + 35);
        int rivalDefense = (int) (Math.random() * 5 + 10);
        ...
        int damageDealth = (rivalHealth - rivalHealthRemaining);
        int bonusPoints = Math.min(damageDealth, 100);
        int totalRizz = (basePoints + bonusPoints);
        // ============================================================
